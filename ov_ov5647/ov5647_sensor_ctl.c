...
static void ov5647_linear_1920p30_init(VI_PIPE ViPipe);
...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunOv5647_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOv5647_AddrInfo[ViPipe].s8I2cAddr);
}

int ov5647_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunOv5647_BusInfo[ViPipe].s8I2cDev);
}

int ov5647_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunOv5647_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOv5647_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							ov5647_addr_byte, ov5647_data_byte);
}

int ov5647_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunOv5647_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOv5647_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							ov5647_addr_byte, (CVI_U32)data, ov5647_data_byte);
}
...
void ov5647_init(VI_PIPE ViPipe)
{
	...
	ov5647_linear_1920p30_init(ViPipe);
...
static void ov5647_linear_1920p30_init(VI_PIPE ViPipe)
{
	...
	printf("ViPipe:%d,===OV5647 1920P 30fps 10bit LINE Init OK!===\n", ViPipe);
}
